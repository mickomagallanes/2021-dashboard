...
INSERT INTO `EmployeePositions` VALUES (1,'Programmer'),(2,'Teacher'),(5,'ghighi');
...
INSERT INTO `EmployeeSalaries` VALUES (1,'50000','2021-08-08',NULL,2),(2,'4444','2021-08-08',NULL,1),(7,'999999999996','2021-08-13',NULL,1),(11,'56565656','2021-08-27',NULL,6),(12,'8844','2021-08-17','2021-08-17',6),(13,'8888','2021-08-17','2021-08-17',6);
...
INSERT INTO `Employees` VALUES (1,'EMP-1','Dorco','Sam','Magallanes','F','098492495012','2000-05-30','1998-04-23',1,1),(2,'EMP-00002','Freddy','Marquez','Maroon','M','09894930921','2021-08-01','2021-08-31',1,1),(6,'1a','2b','3c','4d','F','09876598431','2021-08-02','1988-08-09',3,2);
...
INSERT INTO `Menus` VALUES (1,'Users',2,1),(2,'Roles',2,5),(5,'Home',NULL,2),(6,'ParentMenus',3,6),(7,'Menus',3,7),(9,'Pages',3,8),(15,'Subpages',3,10),(53,'Salary',23,37),(54,'Routes',3,38),(55,'Employee',23,39),(58,'Department',23,40),(59,'Positions',23,41),(96,'testone',3,61);
...
) ENGINE=InnoDB AUTO_INCREMENT=453 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `PageRoles` VALUES (1,1,1,1),(2,2,1,1),(3,2,2,1),(4,1,2,1),(5,1,3,2),(6,2,3,2),(7,5,1,3),(35,5,2,3),(38,5,3,2),(59,6,1,3),(60,7,1,3),(88,6,3,2),(89,7,3,2),(95,8,1,3),(190,10,1,3),(309,37,1,1),(311,38,1,3),(316,39,1,1),(317,40,1,1),(318,41,1,1),(324,1,19,1),(325,2,19,1),(326,5,19,1),(327,6,19,1),(328,7,19,1),(329,8,19,1),(330,10,19,1),(331,37,19,1),(332,38,19,1),(333,39,19,1),(334,40,19,1),(335,41,19,1),(375,6,2,3),(376,7,2,3),(377,8,2,3),(378,10,2,3),(379,37,2,3),(380,38,2,3),(381,39,2,3),(382,40,2,3),(383,41,2,3),(452,61,19,2);
...
INSERT INTO `Pages` VALUES (1,'Users','/users'),(2,'Home','/home'),(5,'Roles','/roles'),(6,'ParentMenus','/parentmenus'),(7,'Menus','/menus'),(8,'Pages','/pages'),(10,'SubPages','/subpages'),(37,'EmployeeSalaries','/employee/salaries'),(38,'Routes','/routes'),(39,'Employees','/employees'),(40,'EmployeeDepartments','/employee/departments'),(41,'EmployeePositions','/employee/positions'),(61,'test1','/test1');
...
INSERT INTO `ParentMenus` VALUES (2,'Users And Roles',2),(3,'App\'s Components and Menus',1),(23,'Employees',24),(24,'aaaaaaaaaaaa',23);
...
) ENGINE=InnoDB AUTO_INCREMENT=308 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `