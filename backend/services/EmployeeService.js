...
class EmployeeService {
    ...
    static async deleteEmployeePosition(employeePositionID) {
        ...
        let ret = await EmployeePositionModel.crud.deleteRow(employeePositionID);
    ...
    static async deleteBulkEmployeePosition(idArray) {
        ...
        let ret = await EmployeePositionModel.crud.deleteBulkRows(idArray);
    ...
    */
    ...
    static async getAllEmployeePositions({ page, limit, sortBy, order, filter }) {
        ...
        let employeePositionArr = await EmployeePositionModel.crud.getAll({
    ...
    static async getEmployeePositionById(id) {
        let ret = await EmployeePositionModel.crud.getById(id);
    ...
    static async getAllEmployeePositionCount({ filter }) {
        ...
        const employeePositionCount = await EmployeePositionModel.crud.getAllCount({ filter });
    ...
    static async deleteEmployeeDepartment(employeeDepartmentID) {
        ...
        let ret = await EmployeeDepartmentModel.crud.deleteRow(employeeDepartmentID);
    ...
    static async deleteBulkEmployeeDepartment(idArray) {
        ...
        let ret = await EmployeeDepartmentModel.crud.deleteBulkRows(idArray);
    ...
    */
    ...
    static async getAllEmployeeDepartments({ page, limit, sortBy, order, filter }) {
        ...
        let employeeDepartmentArr = await EmployeeDepartmentModel.crud.getAll({
            startIndex: startIndex,
            limit: limit,
            sortBy: sortBy,
            order: order,
    ...
    static async getEmployeeDepartmentById(id) {
        let ret = await EmployeeDepartmentModel.crud.getById(id);
    ...
    static async getAllEmployeeDepartmentCount({ filter }) {
        ...
        const employeeDepartmentCount = await EmployeeDepartmentModel.crud.getAllCount({ filter });
    ...
    static async deleteEmployeeSalary(employeeSalaryID) {
        ...
        let ret = await EmployeeSalaryModel.crud.deleteRow(employeeSalaryID);
    ...
    static async deleteBulkEmployeeSalary(idArray) {
        ...
        let ret = await EmployeeSalaryModel.crud.deleteBulkRows(idArray);
    ...
    */
    ...
    static async getAllEmployeeSalaries({ page, limit, sortBy, order, filter }) {
        ...
        let employeeSalaryArr = await EmployeeSalaryModel.crud.getAll({
            startIndex: startIndex,
            limit: limit,
            sortBy: sortBy,
            order: order,
    ...
    static async getEmployeeSalaryById(id) {
        let ret = await EmployeeSalaryModel.crud.getById(id);
    ...
    static async getAllEmployeeSalaryCount({ filter }) {
        ...
        const employeeSalaryCount = await EmployeeSalaryModel.crud.getAllCount({ filter });
    ...
    static async deleteEmployee(employeeID) {
        ...
        let ret = await EmployeeModel.crud.deleteRow(employeeID);
    ...
    static async deleteBulkEmployee(idArray) {
        ...
        let ret = await EmployeeModel.crud.deleteBulkRows(idArray);
    ...
    */
    ...
    static async getAllEmployee({ page, limit, sortBy, order, filter }) {
        ...
        let employeeArr = await EmployeeModel.crud.getAll({
            startIndex: startIndex,
            limit: limit,
            sortBy: sortBy,
            order: order,
    ...
    static async getEmployeeById(id) {
        let ret = await EmployeeModel.crud.getById(id);
    ...
    static async getAllEmployeeCount({ filter }) {
        ...
        const employeeCount = await EmployeeModel.crud.getAllCount({ filter });
