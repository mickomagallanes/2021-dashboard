...
class MenusService {
    ...
    static async deleteMenu(menuID) {
        ...
        let ret = await MenuModel.crud.deleteRow(menuID);
    ...
    static async deleteBulkMenu(idArray) {
        ...
        let ret = await MenuModel.crud.deleteBulkRows(idArray);
    ...
    */
    ...
    static async getAllMenus({ page, limit, sortBy, order, filter }) {
        ...
        let menuArr = await MenuModel.crud.getAll({
            startIndex,
            limit,
            sortBy,
            order,
    ...
    static async getMenuById(id) {
        let ret = await MenuModel.crud.getById(id);
    ...
    static async getAllMenuCount({ filter }) {
        ...
        const menuCount = await MenuModel.crud.getAllCount({ filter });
    ...
    static async deleteParentMenu(parentMenuID) {
        ...
        let ret = await ParentMenuModel.crud.deleteRow(parentMenuID);
    ...
    static async deleteBulkParentMenu(idArray) {
        ...
        let ret = await ParentMenuModel.crud.deleteBulkRows(idArray);
    ...
    */
    ...
    static async getAllParentMenus({ page, limit, sortBy, order, filter }) {
        ...
        let parentMenuArr = await ParentMenuModel.crud.getAll({
    ...
    static async getParentMenuById(id) {
        let ret = await ParentMenuModel.crud.getById(id);
    ...
    static async getAllParentMenuCount({ filter }) {
        ...
        const parentMenuCount = await ParentMenuModel.crud.getAllCount({ filter });
